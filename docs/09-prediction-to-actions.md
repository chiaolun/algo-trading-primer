...
<svg viewBox="0 0 640 400" role="img" aria-label="Alpha decay curves for a fast- and a slow-decaying signal" style="width:100%;height:auto;display:block;color:var(--md-default-fg-color)">
...
<figure style="margin:1.5rem 0;width:100%">
<svg viewBox="0 0 640 400" role="img" aria-label="Gross alpha, transaction cost, and net alpha versus trading speed" style="width:100%;height:auto;display:block;color:var(--md-default-fg-color)">
